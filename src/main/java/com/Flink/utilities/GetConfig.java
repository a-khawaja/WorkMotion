...
public class GetConfig {
     ...
     * @param propertyValue Value to be updated for the property name
     *
     * @throws IOException
     */
    public static void updateProperties(String property, String propertyValue) throws IOException, ConfigurationException {
